...
char playername[MAX_NAME_LEN]={0};
...
double ranking[RANKING_SIZE] ={
  1.00000,1.66666,2.00000,2.33333,3.00000,   3.33333,4.33333,5.00000,5.33333,6.66666,   7.00000,7.33333,9.00000,9.33333,10.00000,
};
//ランキングの名前の初期化
char startname[RANKING_SIZE][MAX_NAME_LEN]= {
"Taro","Hanako","Kaoru12","Taichi..","RyoMa",   "12345","AIUEO","IMO","uuuu","WtoY",   "tata","purin","study","tani19","mama"
};
